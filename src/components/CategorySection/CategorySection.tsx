      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
          {categories.map((category) => (
            ...
            >
              <div
                className={`rounded-2xl p-6 h-full bg-white/70 backdrop-blur-md border border-white/30 transition-all duration-300 transform group-hover:scale-105 group-hover:shadow-lg`}
              >
