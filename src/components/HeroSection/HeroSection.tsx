        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          ...
          <div className='text-center lg:text-right'>
            ...
            <p className='text-lg md:text-xl text-gray-600 mb-8 leading-relaxed drop-shadow'>
              با بارسان طب، دسترسی آسان به بهترین عطاری‌ها، پزشکان متخصص و
          ...
          <div className='relative z-10'>
            <div className='relative z-10'>
              <div className='rounded-3xl p-8 lg:p-12 bg-white/60 backdrop-blur-md border border-white/30 shadow-xl'>
            ...
            {/* Decorative elements */}
            <div className='absolute -top-4 -right-4 w-24 h-24 bg-emerald-300/60 rounded-full'></div>
            <div className='absolute -bottom-4 -left-4 w-16 h-16 bg-emerald-400/60 rounded-full'></div>
          </div>
        </div>
      </div>
    </section>
