...
const AISection = () => {
  const aiFeatures = [
    ...
    },
    {
      ...
      title: 'تشخیص بیماری',
      description:
        'با توصیف علائم، بیماری احتمالی و راه‌های درمان را معرفی می‌کند',
      icon: '🏥',
      color: 'bg-red-100',
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='text-center mb-12'>
          ...
          <p className='text-lg text-gray-600 max-w-2xl mx-auto'>
            با استفاده از هوش مصنوعی پیشرفته، خدمات پزشکی و تغذیه‌ای هوشمند
            دریافت کنید
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            {aiFeatures.map((feature) => (
              <div
                key={feature.id}
                className={`bg-white/70 backdrop-blur-md rounded-2xl p-6 hover:shadow-xl border border-white/30 transition-all duration-300 transform hover:scale-105`}
              >
                <div className='text-4xl mb-4'>{feature.icon}</div>
                <h3
                  className={`text-xl font-semibold ${feature.textColor} mb-2`}
                >
                  {feature.title}
                </h3>
          ...
          <div className='bg-white/70 backdrop-blur-md rounded-3xl p-8 shadow-xl border border-white/30'>
            <div className='text-center mb-8'>
              ...
              <p className='text-gray-600'>
                با هوش مصنوعی بارسان طب گفتگو کنید و پاسخ سوالات خود را دریافت
                کنید
              </p>
            </div>
